...
let indexes = [| 0; 3 |]
let t1 = t.[tensor.index2 1, tensor.index2 indexes, tensor.index2 (Numerics.NET.Range(3, 5))]
// t2 -> [[ 103 133 ]
//        [ 104 134 ]]
...
let t2 = t.[tensor.index2 1, tensor.index2 mask, tensor.index2 (Numerics.NET.Range(3, 5))]
// t2 -> [[ 103 133 ]
//        [ 104 134 ]]
